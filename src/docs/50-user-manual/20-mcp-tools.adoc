...
Searches for relevant sections, builds a context prompt, and calls an LLM provider to generate an answer.
...
| `max_sections` | int | 5 | Maximum documentation sections to include as context
|===
