...
# 6. (Experimental) Ask a question about the docs
dacli --docs-root /project/docs ask "How is the database configured?"
----
...
| `ask QUESTION` | [experimental] Ask a question about the documentation using an LLM
|===
