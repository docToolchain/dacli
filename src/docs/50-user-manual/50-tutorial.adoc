...
The CLI is included with the MCP Documentation Server. Ensure you have:
...
[source,bash]
----
uv run dacli --docs-root /path/to/docs structure --max-depth 1
----
...
[source,bash]
----
uv run dacli --docs-root /path/to/docs section architecture.decisions
----
...
[source,bash]
----
uv run dacli --docs-root /path/to/docs section intro
----
...
[source,bash]
----
uv run dacli --docs-root /path/to/docs search "database" --scope architecture --max-results 5
----
...
[source,bash]
----
uv run dacli --docs-root /path/to/docs sections-at-level 1
----
...
[source,bash]
----
uv run dacli --docs-root /path/to/docs elements --type code
----
...
[source,bash]
----
uv run dacli --docs-root /path/to/docs elements --type table --section architecture
----
...
[source,bash]
----
uv run dacli --docs-root /path/to/docs metadata
----
...
[source,bash]
----
uv run dacli --docs-root /path/to/docs metadata architecture.decisions
----
...
[source,bash]
----
uv run dacli --docs-root /path/to/docs validate
----
...
[source,bash]
----
uv run dacli --docs-root /path/to/docs update introduction --content "== Introduction
...
[source,bash]
----
uv run dacli --docs-root /path/to/docs update introduction \
  --content "New content..." \
...
[source,bash]
----
uv run dacli --docs-root /path/to/docs insert architecture \
  --position after \
...
[source,bash]
----
uv run dacli --docs-root /path/to/docs --pretty metadata
----
...
[source,bash]
----
uv run dacli --docs-root /path/to/docs --format yaml metadata
----
...
[source,bash]
----
uv run dacli --docs-root /path/to/docs --format text metadata
----
...
structure=$(uv run dacli --docs-root /project/docs structure --max-depth 2)

# 2. Search for relevant content
results=$(uv run dacli --docs-root /project/docs search "database configuration")

# 3. Read the relevant section
content=$(uv run dacli --docs-root /project/docs section deployment.database)

# 4. Update the documentation
uv run dacli --docs-root /project/docs update deployment.database \
  --content "Updated database configuration documentation..."

# 5. Verify the structure is still valid
uv run dacli --docs-root /project/docs validate
----
