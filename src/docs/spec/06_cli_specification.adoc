...
Searches for relevant documentation sections, builds a context prompt, and calls an LLM provider to generate an answer.
...
* `--max-sections N`: Maximum number of documentation sections to include as context (default: 5)
